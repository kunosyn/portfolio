...
export default function NotFound () {
  return (
    <main className='z-0 bg-neutral-950 text-white select-none'>
      <section className='min-h-screen max-h-screen flex justify-center'>
        <MaxWidthWrapper className='z-10 text-center justify-center w-full flex flex-col gap-6 placeholder:items-center'>
          ...
          <h1 className='text-4xl animate-glow-flicker appearance-none'>PAGE NOT FOUND</h1>
          
          <div className='flex flex-col gap-6 justify-center text-center items-center mt-10'>
